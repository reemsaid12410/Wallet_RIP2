...
import models.Category;
    public class MainFrame extends JFrame {
        ...
        private void colorCategory(JLabel cat, String category) {
        ...
        private void attachEvents() {
            btnAdd.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    AddExpensePanal p = new AddExpensePanal();
                    p.setVisible(true);
                    dispose();
                }
            });
            ...
            btnView.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ViewExpensesFrame f = new ViewExpensesFrame(manager);
                    f.setVisible(true);
                    dispose();
                }
            });
            ...
            btnCategories.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    CategoriesFrame f = new CategoriesFrame(manager);
                    f.setVisible(true);
                    dispose();
                }
            });
            ...
            btnLogout.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    LoginFrame f = new LoginFrame(new ExpenseManager());
                    f.setVisible(true);
                    dispose();
                }
            });
